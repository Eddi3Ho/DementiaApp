...
public class HostTips extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.host_tips);
        try
        {
            this.getSupportActionBar().hide();
        }
        catch (NullPointerException e){}
        setStatusBarGradiant(HostTips.this);
        ...
        fabback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(HostTips.this, ReadActivity.class);
    ...
    private void replaceFragment(Fragment fragment){
        ...
        fragmentTransaction.replace(R.id.host_fragment_tips, fragment);
