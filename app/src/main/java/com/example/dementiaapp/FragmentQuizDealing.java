                ...
                .get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            //if user exist
                            if (document.exists()) {
                                Boolean compelete = document.getBoolean("quiz_complete_dealing");
                                if(compelete){
                                    int color = getResources().getColor(R.color.light_green);
                                    int red_color = getResources().getColor(R.color.light_red);

                                    if(radioGroups[0].getCheckedRadioButtonId() != R.id.a1){
                                        RadioButton a1 = (RadioButton) view.findViewById(R.id.a1);
                                    ...
                                    if(radioGroups[4].getCheckedRadioButtonId() != R.id.a5){
                                        RadioButton e1 = (RadioButton) view.findViewById(R.id.a5);
                                        e1.setBackgroundColor(color);

                                        RadioButton selectedRadioButton = view.findViewById(radioGroups[4].getCheckedRadioButtonId());
                                        selectedRadioButton.setBackgroundColor(red_color);
                                    }
                                    if(radioGroups[5].getCheckedRadioButtonId() != R.id.b6){
                                        RadioButton f1 = (RadioButton) view.findViewById(R.id.b6);
                                    ...
                                    if(radioGroups[7].getCheckedRadioButtonId() != R.id.a8){
                                        RadioButton h1 = (RadioButton) view.findViewById(R.id.a8);
        ...
        comletebtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(radioGroups[0].getCheckedRadioButtonId() == -1 || radioGroups[1].getCheckedRadioButtonId() == -1 || radioGroups[2].getCheckedRadioButtonId() == -1 || radioGroups[3].getCheckedRadioButtonId() == -1
                    ...
                    int score = 0;
                    if(radioGroups[0].getCheckedRadioButtonId() == R.id.a1){ score++; }
                    ...
                    if(radioGroups[4].getCheckedRadioButtonId() == R.id.a5){ score++; }
                    if(radioGroups[5].getCheckedRadioButtonId() == R.id.b6){ score++; }
                    if(radioGroups[6].getCheckedRadioButtonId() == R.id.c7){ score++; }
                    if(radioGroups[7].getCheckedRadioButtonId() == R.id.a8){ score++; }
